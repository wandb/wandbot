...
cd wandbot
poetry install
# Choose the platform application you wish to run on and execute the corresponding command:
# poetry install --extras discord # for running on Discord
# poetry install --extras slack # for running on Slack
# poetry install --extras api # for running the API
```
