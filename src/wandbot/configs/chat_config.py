...
class ChatConfig(BaseSettings):    
    ...
    query_enhancer_model: str = "gemini-2.5-flash-lite" #"gemini-2.0-flash-001" 
    query_enhancer_temperature: float = 1.0
    query_enhancer_fallback_provider: str = "google"
    query_enhancer_fallback_model: str = "gemini-2.5-flash-lite" #"gemini-2.0-flash-001" 
    ...
    response_synthesizer_thinking_budget: float | str = 1000
